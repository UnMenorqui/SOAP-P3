 ...
 * 
 */
@WebServiceClient(name = "HotelWS", targetNamespace = "http://hoteles.soap.app/", wsdlLocation = "http://localhost:8080/Hotel/HotelWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELWS_QNAME = new QName("http://hoteles.soap.app/", "HotelWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Hotel/HotelWS?wsdl");
    ...
    public HotelWS getHotelWSPort() {
        return super.getPort(new QName("http://hoteles.soap.app/", "HotelWSPort"), HotelWS.class);
    }
    ...
    public HotelWS getHotelWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hoteles.soap.app/", "HotelWSPort"), HotelWS.class, features);
    }
